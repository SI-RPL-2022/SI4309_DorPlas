    ...
    <div class="row">
        <div class="col-md-6 col-sm-12 d-flex">
            <div class=" flex-column mx-auto" style="padding-top: 200px">
                ...
                <p class="text-left text-body1 pb-2 my-2" style="max-width: 500px">“Kebaikan sejati dan tulus adalah
                    kebaikan yang dilakukan tanpa diketahui orang yang menerima kebaikan.”</p>
