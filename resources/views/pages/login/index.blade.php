    ...
    <div class="row">
        <div class="col-md-6 col-sm-12 d-flex">
            <div class=" flex-column mx-auto" style="padding-top: 200px">
                ...
                <p class="text-left text-body1 pb-2 my-2" style="max-width: 500px">“Kebaikan yang kita berikan pada
                    orang lain sesungguhnya adalah kebaikan yang kita tanam untuk diri sendiri”</p>
